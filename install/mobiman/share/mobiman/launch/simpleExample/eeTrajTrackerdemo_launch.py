...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('a1_ee_target_traj', default_value='/a1_ee_target_traj_1'),
        DeclareLaunchArgument('ee_frame', default_value='arm_seg6'),
        Node(
            package='mobiman',
            executable='eeTrajTracker_demo_node',
            name='eeTrajTracker_demo_node',
            output='screen',
            parameters=[{
                ...
                'a1_ee_target_traj': LaunchConfiguration('a1_ee_target_traj'),
