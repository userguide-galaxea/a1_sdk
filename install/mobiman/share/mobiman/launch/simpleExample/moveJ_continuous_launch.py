...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('recordedFile', default_value=os.path.join(
            FindPackageShare('mobiman').find('mobiman'),
            'data/joint_angles.txt'
        )),
        DeclareLaunchArgument('stepDebug', default_value= 'false'),
        ...
        Node(
            package='mobiman',
            executable='moveJ_continuous',
            name='moveJ_continuous',
            output='screen',
            parameters=[{
                'stepDebug': LaunchConfiguration('stepDebug'),
                'recordedFile': LaunchConfiguration('recordedFile'),
